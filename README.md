...
Parameters: 
        ...
        -algorithm.meanshift.maxiter       <int32>          max number of iterations  (optional, on by default, default value is 10)
        -algorithm.meanshift.spatialr      <float>          Spatial bandwidth  (optional, on by default, default value is 2)
        -algorithm.meanshift.spectralr     <float>          Spectral bandwidth  (optional, on by default, default value is 50)
